...
\begin{enumerate}
\item Email già registrato
\item Nickname invalido oppure già presente
\item Password non risponde ai criteri stabilita dal sistema
\end{enumerate}
\bigskip
\begin{itshape}
Sign-In
...
Parti Interessate: nessuna\\
scenario principale di successo o di fallimento:
utente immette email e password
utente accede all'applicazione
altrimenti:
il sistema invita a riprovare a mettere email e password
\bigskip
\\
\begin{itshape}
Check-Recipe
\end{itshape}\\
attore primario:
utente: chi desidera consultare le ricette
parti interessati: nessuna
scenario principale di successo o di fallimento:
utente accede al catalogo delle ricette
\bigskip
\\
\begin{itshape}
Add-New-Recipe
\end{itshape}\\
attore primario:
utente: chi desidera condividere la propria ricetta
parti interessati: nessuna
scenario principale di successo o di fallimento:
utente crea una nuova ricetta
\bigskip
\\
\begin{itshape}
Modify-Recipe
\end{itshape}\\
attore primario:
utente: chi desidera apportare modifica alle ricette presenti nel ricettario
parti interessati: nessuna
scenario principale di successo o di fallimento:
utente modifica uno o più ingrediente presenti in una ricetta
utente modifica la quantità di uno o più ingrediente della ricetta
utente apporta le modifiche
altrimenti:
il sistema non accetta le modifiche apportate dall'utente
\bigskip
\\
\begin{itshape}
Delete-Recipe
\end{itshape}\\
attore primario:
utente: chi desidera cancellare una o più ricette presenti nel ricettario
parti interessati:
sistema
scenario principale di successo o di fallimento:
utente cancella la ricetta
il sistema cancella la ricetta dal database
\bigskip
\\
\begin{itshape}
Add-Ingredient
\end{itshape}\\
attore primario:
utente: aggiunge gli nuovi ingredienti nel magazzino
parti interessati:
sistema: accede la magazzino

scenario principale di successso o di fallimento:
utente inserisce ingrediente/i
il sistema controlla se ingrediente è già presente nel magazzino
il sistme inserisce ingrediente nel database
altrimenti:
ingrediente è già presente nel database:
il sistema informa utente che ingrediente è già presente nel magazzino
\bigskip
\\
\begin{itshape}
Delete-Ingredint
\end{itshape}\\
attore primario:
utente: chi desidera cancellare un o più ingredienti dal magazzino
parti interessati:
sistema: cancella ingrediente/i dal database
scenario principale di successo o di fallimento:
il sistema cancella ingrediente/i selezionato/i dall'utente
\bigskip
\\
\begin{itshape}
Stamp-Recipe
\end{itshape}\\
attore primario:
sistema: genera un documento relativo alla ricetta
parti interessati:
utente: visualizza a video il documento
scenario principale di successo o di fallimento:
viene visualizzata la ricetta
\bigskip
\\
\begin{itshape}
Prepare-Beer
\end{itshape}\\
attore primario:
utente: chi desidera preparare un tipo di birra 
parti interessati:
sistema
scenario principale di successo o di fallimento:
utente accede alla sezione ricettario
utente inserisce gli ingredienti disponibili
il sistema visualizza le possibili ricette che si possono creare
il sistema visualizza gli ingredienti mancanti
il sistema visualizza gli strumenti necessari per preparare la ricetta

\section{Activity}

\begin{figure}[H]
\includegraphics[scale=0.6]{ActivityDiagram.jpg}
\centering
\end{figure}
...
\section{Statechart}
\begin{figure}[H]
\includegraphics[scale=0.6]{Statechart.png}
\end{figure}
\section{Test}
